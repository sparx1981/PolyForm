...
async function main() {
  ...
  throw new Error('Usage: discover | discover-models [--slugs a,b,c] | download-models [--slugs a,b,c] [--tier 1k] [--out DIR] | plan --release ID [--manifest FILE] [--category SLUG ...] [--limit N] [--exclude ID ...] [--out FILE] | ingest --plan FILE --resume | convert --release ID | validate --release ID | publish --release ID [--dry-run]');
}
