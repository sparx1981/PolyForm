      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between text-[11px]">
          <span className="font-bold uppercase tracking-wider text-gray-500 flex items-center gap-1.5">
            <Ruler size={13} className="text-polyform-blue" />
          ...
          <div className="flex items-center gap-1">
            <input
              ...
              className="w-16 h-6 px-1.5 text-right font-mono text-xs rounded bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-1 focus:ring-polyform-blue"
            />
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isSelected
                    ? "bg-polyform-blue text-white shadow-xs font-semibold"
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isSelected
                    ? "border-polyform-blue bg-polyform-blue/10 ring-1 ring-polyform-blue"
              ...
              >
                ...
                {isSelected && (
                  <Check size={14} className="text-polyform-blue shrink-0" />
                )}
              </button>
            );
          })}
