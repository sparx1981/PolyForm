  ...
  return (
    ...
    >
      ...
      {activeLandscapeCategory && (
        <div className={`absolute left-full ml-2 top-2 ${activeLandscapeCategory === 'style' || activeLandscapeCategory === 'plant' ? 'w-88' : 'w-72'} p-3.5 rounded-xl border backdrop-blur-md shadow-2xl z-50 text-xs ${
