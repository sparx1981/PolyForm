...
export const CHANGELOG_DATA: ChangelogEntry[] = [
  ...
  },
  {
    ...
    items: [
      ...
      'Improved SKP Compatibility: Upgraded the binary file detection logic to catch UTF-16 and non-standard encoded SKP signatures, providing users with accurate instructions on using the GLTF bridge.',
      ...
      'UI Menu Refinement: Renamed the Project "Export" menu to "Import / Export" to better represent the inclusion of SKP and GLTF bridge import tools.',
      ...
      'SKP (.skp) Integration: Introduced high-fidelity bridge support for importing and exporting SKP files. The new "Import SKP" and "Export SKP" options are available under the Project > Export sub-menu.',
      'Embedded Webpage SDK: Launched `sdk.openWebpage(url)`, allowing developers to host and open interactive web documentation or asset libraries directly within the PolyForm workspace.',
